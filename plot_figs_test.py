...
# file_path = 'data/imu_data.csv'
# file_path = 'data/serial_data_reading.csv'    
# file_path = 'data/bluetooth_data_reading.csv'    
# file_path = 'RL_Controller_torch/bluetooth_data_reading.csv'    

# file_path = 'imu_reading/imu_serial_python/imu_data_new.csv'  
file_path = 'data/bluetooth_data_comparison.csv'
...
plt.savefig('figures/test_per_bluetooth.png')     
# plt.savefig('figures/test_per_serial.png')     
